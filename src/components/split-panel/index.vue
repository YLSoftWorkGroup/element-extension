<template>
  <div :style="{ cursor, userSelect}" class="yl-splitter-container clearfix" @mouseup="onMouseUp" @mousemove="onMouseMove">
    ...
    <div class="yl-splitter-container-mask" v-if="active"></div>
  </div>
</template>

<script>
  import Resizer from './resizer.vue'
  import Pane from './split-panel.vue'
...
.yl-splitter-container {
  height: 100%;
  position: relative;
}

.yl-splitter-container-mask {
  z-index: 9999;
  width: 100%;
  height: 100%;
  position: absolute;
