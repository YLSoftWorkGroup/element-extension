...
// EXTERNAL MODULE: ./node_modules/_dayjs@1.8.14@dayjs/dayjs.min.js
  ...
  methods: {
    ...
    _initDate: function _initDate(type) {
      if (type === 'day') {
        ...
        var quarter = (dayjs_min_default()().month() + 1) / 4;
    ...
    renderItem: function renderItem(h, columns, columnDefaultAttr) {
      ...
      return columns.map(function (column) {
        ...
        if (column.isParent) {
          ...
          }, [_this.renderItem(column.items, columnDefaultAttr)]);
        } else {
          return h("el-table-column", {
            attrs: {
              type: columnAttr.type,
...
var components = [flexbox, panel, toolbar, timebar, pageheader, table, tabler, tablen, onlytable, tableedit, list, listr, listn, treeselect, commontree, commonpaneltree, Map];
